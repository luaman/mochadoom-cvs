...
//-----------------------------------------------------------------------------
//
// $Id: TrueColorRenderer.java,v 1.1 2011/10/11 13:23:55 velktron Exp $
//
...
static final String rcsid = "$Id: TrueColorRenderer.java,v 1.1 2011/10/11 13:23:55 velktron Exp $";
...
{ 
 ...
 for (i=0 ; i<screens.length ; i++){
  ...
  this.currentscreen=new BufferedImage(width,height, BufferedImage.TYPE_INT_ARGB);
