...
import static m.fixed_t.FRACBITS;
	...
	public abstract class R_DrawColumnBoomOpt<T,V> extends DoomColumnFunction<T,V> {
        ...
        public static final class HiColor extends R_DrawColumnBoomOpt<byte[],short[]>{
        ...
        public static final class Indexed extends R_DrawColumnBoomOpt<byte[],byte[]>{
