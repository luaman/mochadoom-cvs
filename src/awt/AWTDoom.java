...
public abstract class AWTDoom<V> extends DoomFrame<V> {
    ...
    private static final long serialVersionUID = 1L;
        ...
        public AWTDoom(DoomMain<byte[],V> DM, DoomVideoRenderer<V> V) {
      		super(DM, V);
      		drawhere=new Canvas();
...
public static final class HiColor extends AWTDoom<short[]>{
    ...
    public HiColor(DoomMain<byte[], short[]> DM, DoomVideoRenderer<short[]> V) {
        super(DM, V);
    }
...
public static final class Indexed extends AWTDoom<byte[]>{
    ...
    public Indexed(DoomMain<byte[], byte[]> DM, DoomVideoRenderer<byte[]> V) {
        super(DM, V);
    }
